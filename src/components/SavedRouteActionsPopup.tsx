...
interface SavedRouteActionsPopupProps {
  isOpen: boolean;
  onClose: () => void;
  onShare: () => void;
  onRemove: () => void;
...
export default function SavedRouteActionsPopup({ isOpen, onClose, onShare, onRemove, routeImage }: SavedRouteActionsPopupProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <>
