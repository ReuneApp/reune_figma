import svgPaths from "./svg-iqnhk782gf";
...
function People({ className }: { className?: string }) {
  return (
    <div className={className} data-name="people">
      <div className="absolute bottom-[12.5%] left-0 right-0 top-[12.5%]" data-name="Vector">
        <div className="absolute inset-[-1.33%_-1%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21 16">
            <path d={svgPaths.p1ca0b900} fill="var(--fill-0, black)" id="Vector" stroke="var(--stroke-0, black)" strokeWidth="0.2" />
          </svg>
        </div>
      </div>
    </div>
...
function Button5() {
  return (
    <div className="absolute bg-white box-border content-stretch flex items-center justify-center left-[265px] pl-[3.691px] pr-[3.701px] py-[3.691px] rounded-[16px] size-[47.994px] top-[28px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-[3.691px] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]" />
      <People className="relative shrink-0 size-[20px]" />
    </div>
  );
}
...
function Location() {
  return (
    <div className="absolute bg-white box-border content-stretch flex h-[48px] items-center justify-center left-[112px] pl-[10px] pr-[20px] py-[10px] rounded-[16px] top-[255px]" data-name="LOCATION">
...
function HomeFeed() {
  return (
    <div className="bg-white h-[852.649px] overflow-clip relative shrink-0 w-[393.719px]" data-name="HomeFeed">
      ...
      <Button4 />
      <Button5 />
      <p className="absolute font-['Baloo_Tamma:Regular',sans-serif] leading-[normal] left-[197px] not-italic text-[#1e1e1e] text-[22px] text-center text-nowrap top-[217px] translate-x-[-50%] whitespace-pre">GEORGE</p>
      <Tabs />
      <Location />
    </div>
  );
