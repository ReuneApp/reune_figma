import svgPaths from "./svg-1n7so91zsa";
...
function Frame() {
  return (
    <div className="absolute h-[130px] left-0 top-0 w-[340px]">
      ...
      <p className="absolute font-['Baloo_Tamma:Regular',sans-serif] inset-[38.46%_9.71%] leading-[normal] not-italic text-[22px] text-[rgba(30,30,30,0.4)] text-center">SELECT A PLACE</p>
    </div>
  );
}
...
export default function CreatePageMapIdle() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Create Page (Map) Idle">
      <Container32 />
    </div>
  );
}