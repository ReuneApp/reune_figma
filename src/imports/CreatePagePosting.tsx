import svgPaths from "./svg-2k7cusq6fk";
...
function SwitchButtonOn() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[18px] inset-[46.34%_5.88%_36.59%_5.88%] items-center justify-center px-[20px] py-[10px] rounded-[20px]" data-name="SWITCH BUTTON (ON)">
...
function MusicBox() {
  return (
    <div className="absolute bg-white border-4 border-[#e9e9e9] border-solid inset-[26.59%_5.29%_56.34%_5.29%] rounded-[20px] shadow-[0px_3px_15px_0px_rgba(0,0,0,0.25)]" data-name="MUSIC BOX">
      <Music />
