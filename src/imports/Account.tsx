import svgPaths from "./svg-gnkyh60uzt";
...
function DefaultButton() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[18px] h-[70px] items-center justify-center left-[47px] px-[20px] py-[10px] rounded-[20px] top-[597.02px] w-[300px]" data-name="DEFAULT (BUTTON)">
      ...
      <p className="font-['Baloo_Tamma:Regular',sans-serif] h-[30px] leading-[normal] not-italic relative shrink-0 text-[#ff232f] text-[22px] text-center w-[242px]">DELETE ACCOUNT</p>
    </div>
  );
}
...
function DefaultButton1() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[18px] h-[70px] items-center justify-center left-[47px] px-[20px] py-[10px] rounded-[20px] top-[279.02px] w-[300px]" data-name="DEFAULT (BUTTON)">
      <div aria-hidden="true" className="absolute border-4 border-[#e9e9e9] border-solid inset-0 pointer-events-none rounded-[20px] shadow-[0px_3px_15px_0px_rgba(0,0,0,0.25)]" />
      <p className="font-['Baloo_Tamma:Regular',sans-serif] h-[30px] leading-[normal] not-italic relative shrink-0 text-[22px] text-[rgba(30,30,30,0.5)] w-[242px]">{`TERMS & CONDITIONS`}</p>
    </div>
  );
}
...
function DefaultButton2() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[18px] h-[70px] items-center justify-center left-[47px] px-[20px] py-[10px] rounded-[20px] top-[194.02px] w-[300px]" data-name="DEFAULT (BUTTON)">
      <div aria-hidden="true" className="absolute border-4 border-[#e9e9e9] border-solid inset-0 pointer-events-none rounded-[20px] shadow-[0px_3px_15px_0px_rgba(0,0,0,0.25)]" />
      <p className="font-['Baloo_Tamma:Regular',sans-serif] h-[30px] leading-[normal] not-italic relative shrink-0 text-[22px] text-black w-[242px]">EMAIL US</p>
    </div>
  );
}
...
function DefaultButton3() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[18px] h-[70px] items-center justify-center left-[47px] px-[20px] py-[10px] rounded-[20px] top-[364.02px] w-[300px]" data-name="DEFAULT (BUTTON)">
      <div aria-hidden="true" className="absolute border-4 border-[#e9e9e9] border-solid inset-0 pointer-events-none rounded-[20px] shadow-[0px_3px_15px_0px_rgba(0,0,0,0.25)]" />
      <p className="font-['Baloo_Tamma:Regular',sans-serif] h-[30px] leading-[normal] not-italic relative shrink-0 text-[22px] text-[rgba(30,30,30,0.5)] w-[242px]">PRIVACY POLICY</p>
    </div>
  );
}
...
function TextField() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[18px] h-[70px] items-center left-[47px] pl-[28px] pr-[20px] py-[10px] rounded-[20px] top-[0.02px] w-[300px]" data-name="TEXT FIELD">
      ...
      <p className="font-['Baloo_Tamma:Regular',sans-serif] h-[30px] leading-[normal] not-italic relative shrink-0 text-[#1e1e1e] text-[22px] w-[210px]">EMAIL</p>
    </div>
  );
}
...
function TextField1() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[18px] h-[70px] items-center left-[47px] pl-[28px] pr-[20px] py-[10px] rounded-[20px] top-[85.02px] w-[300px]" data-name="TEXT FIELD">
      ...
      <p className="font-['Baloo_Tamma:Regular',sans-serif] h-[30px] leading-[normal] not-italic relative shrink-0 text-[#1e1e1e] text-[22px] w-[210px]">PASSWORD</p>
    </div>
  );
}
