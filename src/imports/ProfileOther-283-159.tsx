import svgPaths from "./svg-p9y5ma0sa9";
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="people">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_283_166)" id="people">
          <path d={svgPaths.p33c7a370} fill="var(--fill-0, black)" id="Vector" stroke="var(--stroke-0, black)" strokeWidth="0.2" />
        </g>
        <defs>
