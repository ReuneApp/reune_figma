import svgPaths from "./svg-4qtbpxrgov";
...
function EditorComment({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Editor / Comment">
      <div className="absolute h-[15px] left-[10px] top-[2px] w-[12px]" data-name="shape">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 15">
          <path d={svgPaths.p24b5a00} id="shape" stroke="var(--stroke-0, #1E1E1E)" strokeWidth="3" />
        </svg>
      </div>
    </div>
  );
...
function Location() {
  return (
    <div className="absolute bg-white box-border content-stretch flex items-center justify-center left-[35px] pl-[10px] pr-[20px] py-[10px] rounded-[16px] top-[665px]" data-name="Location">
      <div aria-hidden="true" className="absolute border-4 border-[#e9e9e9] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <EditorComment className="h-[20px] relative shrink-0 w-[32px]" />
