import svgPaths from "./svg-3pbes637su";
import imgImageWithFallback from "figma:asset/64c50f1b0e9d3f0bc87b205f55019d384dc33f1b.png";
import imgImageWithFallback1 from "figma:asset/9844bfd977f4f5988b484778db92f0fb779ff0dc.png";
...
function MonochromeArrowUpRight() {
  return (
    <div className="h-[33.956px] relative w-[33.954px]" data-name="Monochrome / arrow up right">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Monochrome / arrow up right">
          <path d={svgPaths.p220b7700} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.p2b8a880} fill="var(--fill-0, white)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Back() {
  return (
    <div className="absolute bg-[#1abb6c] box-border content-stretch flex items-center justify-center left-[319px] pl-0 pr-[0.01px] py-0 rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] size-[47.994px] top-[633px]" data-name="Back">
      <div className="flex items-center justify-center relative shrink-0 size-[48.02px]" style={{ "--transform-inner-width": "33.953125", "--transform-inner-height": "33.953125" } as React.CSSProperties}>
...
export default function CreatePage1PlaceSelected() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Create Page (1 Place Selected)">
      <Container34 />
    </div>
  );
}