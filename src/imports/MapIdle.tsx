import svgPaths from "./svg-vbh8tma9jv";
...
function SideBar() {
  return (
    <div className="absolute h-[227.965px] left-[322px] top-[28px] w-[47.994px]" data-name="Side Bar">
      <Button6 />
      <Button7 />
    </div>
  );
...
export default function MapIdle() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Map Idle">
      <Container24 />
    </div>
  );
}