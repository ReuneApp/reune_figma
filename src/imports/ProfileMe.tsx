import svgPaths from "./svg-4gxuo5ccf0";
...
function HeroiconsMiniPencilSquare({ className }: { className?: string }) {
  return (
    <div className={className} data-name="heroicons-mini/pencil-square">
      <div className="absolute inset-[9.4%_9.4%_10%_10%]" data-name="Union">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 23">
          <g id="Union">
            <path d={svgPaths.p3db61880} fill="var(--fill-0, black)" />
            <path d={svgPaths.p1ae8e300} fill="var(--fill-0, black)" />
          </g>
        </svg>
      </div>
    </div>
...
function Location() {
  return (
    <div className="absolute bg-white box-border content-stretch flex items-center justify-center left-[113px] pl-[10px] pr-[20px] py-[10px] rounded-[16px] top-[257px]" data-name="Location">
      ...
      <EditorComment />
      <p className="font-['DM_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#1e1e1e] text-[14px] text-nowrap whitespace-pre" style={{ fontVariationSettings: "'opsz' 14" }}>
        neighbourhood
      </p>
    </div>
  );
...
function Tabs() {
  return (
    <div className="absolute box-border content-stretch flex font-['DM_Sans:Black',sans-serif] font-black gap-[32px] items-center justify-center leading-[normal] left-[118px] p-[10px] text-[18px] text-center text-nowrap top-[391px] whitespace-pre" data-name="Tabs">
      <p className="relative shrink-0 text-[#1e1e1e]" style={{ fontVariationSettings: "'opsz' 14" }}>
        posts
      </p>
      <p className="relative shrink-0 text-[rgba(30,30,30,0.4)]" style={{ fontVariationSettings: "'opsz' 14" }}>
        saved
      </p>
    </div>
  );
...
function Back1() {
  return (
    <div className="absolute bg-white box-border content-stretch flex items-center justify-center left-[173px] pl-[3.691px] pr-[3.701px] py-[3.691px] rounded-[16px] size-[47.994px] top-[312px]" data-name="Back">
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-[3.691px] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]" />
      <HeroiconsMiniPencilSquare className="relative shrink-0 size-[28px]" />
    </div>
  );
}
      ...
      <div className="absolute inset-[8.41%_12.68%]" data-name="Vector">
        <div className="absolute inset-[-5.01%_-5.58%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 21">
            <path d={svgPaths.p3c2d5440} id="Vector" stroke="var(--stroke-0, #222222)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.83274" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[37.5%]" data-name="Vector">
        <div className="absolute inset-[-16.67%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 8">
            <path d={svgPaths.p206afc80} id="Vector" stroke="var(--stroke-0, #222222)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.83274" />
          </svg>
        </div>
      </div>
    </div>
...
function SettingsButton() {
  return (
    <div className="relative rounded-[2.06422e+07px] shrink-0 size-[37.988px]" data-name="Settings Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col items-start pb-0 pt-[7.997px] px-[7.997px] relative size-[37.988px]">
        <Icon4 />
      </div>
    </div>
  );
...
function Button4() {
  return (
    <div className="absolute bg-white box-border content-stretch flex items-center justify-center left-[321px] pl-[3.691px] pr-[3.701px] py-[3.691px] rounded-[16px] size-[47.994px] top-[28px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-[3.691px] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]" />
      <SettingsButton />
    </div>
  );
...
function HomeFeed() {
  return (
    <div className="bg-white h-[852.649px] overflow-clip relative shrink-0 w-full" data-name="HomeFeed">
      ...
      <Back />
      <Location />
      <p className="absolute font-['DM_Sans:Black',sans-serif] font-black leading-[normal] left-[197px] text-[#1e1e1e] text-[22px] text-center text-nowrap top-[217px] translate-x-[-50%] whitespace-pre" style={{ fontVariationSettings: "'opsz' 14" }}>
        George
      </p>
      <Tabs />
      <Back1 />
...
export default function ProfileMe() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Profile (Me)">
      <Container25 />
    </div>
  );
}