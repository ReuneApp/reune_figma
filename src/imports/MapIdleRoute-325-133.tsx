import svgPaths from "./svg-9bkikcqlfp";
...
function Button1() {
  return (
    <div className="bg-white h-[95.998px] relative rounded-[24px] shrink-0 w-full" data-name="Button">
      ...
      <div aria-hidden="true" className="absolute border-8 border-[#1abb6c] border-solid inset-0 pointer-events-none rounded-[24px] shadow-[0px_4px_12px_0px_rgba(0,0,0,0.1)]" />
    </div>
  );
}
...
function Container24() {
  return <div className="absolute left-[310px] size-[48px] top-[663px]" data-name="Container" />;
}

function Container25() {
  return <div className="absolute h-[96px] left-[26px] top-[711px] w-[394px]" data-name="Container" />;
}
...
function Button7() {
  return (
    <div className="absolute bg-[#1abb6c] box-border content-stretch flex items-center justify-center left-[263px] pl-0 pr-[0.01px] py-0 rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] size-[47.994px] top-[633px]" data-name="Button">
...
function Button8() {
  return (
    <div className="absolute bg-white box-border content-stretch flex items-center justify-center left-[207px] pl-[3.691px] pr-[3.701px] py-[3.691px] rounded-[16px] size-[47.994px] top-[632px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#e9e9e9] border-[3.691px] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]" />
      <Icon />
    </div>
  );
...
export default function MapIdleRoute() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Map Idle (Route)">
      <Container32 />
    </div>
  );
}